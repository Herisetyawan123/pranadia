        ...
        <div className="bg-[#FFEBEB] px-7 pt-14 pb-20 w-full rounded-xl absolute top-20">
          ...
          <div className="bg-white pb-5 overflow-hidden relative">
            ...
            <div className="flex justify-between mx-6 absolute top-5 right-0 left-0 items-center">
              <p className='text-xs text-[#FF530C] font-semibold'>Kartu Pasien</p>
            ...
            <div className='mx-6 mt-5 flex gap-3'>
              ...
              <div className="flex flex-col items-start w-full gap-1">
                ...
                <span className='font-semibold text-[7px]'>Laki - Laki (1993-04-01)</span>
                <p className='font-normal text-[7px] w-2/3'>Perum Putra Citra Lestari No. C2
                  Kel. Situ, Kec. Sumedang Utara, 
                  Kab. Sumedang</p>
              </div>
            </div>
          </div>
          <div className='bg-[#D41F13] h-5 flex relative'>
            ...
            <div className="w-full flex justify-center h-full items-center">
              <span className='text-white text-[8px]'>www.pranadiamedika.id</span>
            </div>
          </div>
        </div>
